package org.flixel
{
	...
	public class FlxG
	{
		...
		//Custom crap
		static public var sound_pause_not:int = 0;
		...
		static public var music2:FlxSound;
		/**
		...
		static public function playMusic2(Music:Class,Volume:Number=1.0):void
		{
			if(music2 == null)
				music2 = new FlxSound();
			else if(music2.active)
				music2.stop();
			music2.loadEmbedded(Music,true);
