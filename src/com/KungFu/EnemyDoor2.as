package com.KungFu
{
    ...
    public class EnemyDoor2 extends FlxSprite
    {
		...
		private var _type:int = 1;  //Type of enemy to create
		
		public function EnemyDoor2(X:Number,Y:Number,EnemyArray:Array,Attack:Array,P:Player):void
		{
			super(X, Y, Img);
			x = X;
			y = Y;
		...
		private function createEnemy( X:Number , Y:Number ):void
		{
			...
			var ninja:EnemySpear = new EnemySpear(X, Y, _enemy_attacks, _player);
