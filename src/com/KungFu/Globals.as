package com.KungFu 
{
	...
	public class Globals 
	{
		...
		public static var global_level:int = 0; // Current level
		...
		public static function loadGame():void
		{
			...
			//Needs to be uncommented after you reset all of the data :)
		...
		public static function setGoals():void
		{
			...
			//Level 0
			global_coins_goal.push(1);
			global_kills_goal.push(1);
			global_knock_outs_goal.push(10);
			...
			global_timer_goal.push(360);
			global_combo_goal.push(1);
			global_score_goal.push(1);			
			//Level 2
			...
			global_score_goal.push(0);	
			//Level 3
			global_coins_goal.push(3);
			global_kills_goal.push(3);
			global_knock_outs_goal.push(3);
			global_timer_goal.push(0);
			global_combo_goal.push(0);
			global_score_goal.push(0);	
			//Level 4
			global_coins_goal.push(4);
			global_kills_goal.push(4);
			global_knock_outs_goal.push(4);
			global_timer_goal.push(0);
			global_combo_goal.push(0);
			global_score_goal.push(0);	
			//Level 5
			global_coins_goal.push(5);
			global_kills_goal.push(5);
			global_knock_outs_goal.push(5);
			global_timer_goal.push(0);
			global_combo_goal.push(0);
			global_score_goal.push(0);				
			//Level 6
			global_coins_goal.push(6);
			global_kills_goal.push(6);
			global_knock_outs_goal.push(6);
			global_timer_goal.push(0);
			global_combo_goal.push(0);
			global_score_goal.push(0);	
			//Level 7
			global_coins_goal.push(7);
			global_kills_goal.push(7);
			global_knock_outs_goal.push(7);
			global_timer_goal.push(0);
			global_combo_goal.push(0);
			global_score_goal.push(0);
			//Level 8
			global_coins_goal.push(8);
			global_kills_goal.push(8);
			global_knock_outs_goal.push(8);
			global_timer_goal.push(0);
			global_combo_goal.push(0);
			global_score_goal.push(0);					
		}
