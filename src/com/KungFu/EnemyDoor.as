package com.KungFu
{
    ...
    public class EnemyDoor extends FlxSprite
    {
		...
		public function EnemyDoor(X:Number,Y:Number,EnemyArray:Array,Attack:Array,P:Player):void
		{
			super(X, Y, Img);
			x = X;
			y = Y;
