package com.KungFu 
{
	...
	public class PauseText extends FlxLayer
	{
		...
		public function PauseText()
		{
			...
			_square.createGraphic(250, 40, 0x55000000, true);		
		...
		override public function update():void
		{
			...
			if ( ( FlxG.keys.justPressed("C")   ) && PlayState.pause_state == 1 )
			{
				_state = 1;
			}
			
			if ( ( FlxG.keys.justPressed("X")   ) && PlayState.pause_state == 2 )
			{
				_state = 1;
			}	
			
			if ( ( FlxG.keys.justPressed("C")   ) && PlayState.pause_state == 3 )
			{
				_state = 1;
			}
